...
// PG_GYRO_CONFIG
    ...
    { "gyro_calib_duration",        VAR_UINT16 | MASTER_VALUE, .config.minmaxUnsigned = { 25,  3000 }, PG_GYRO_CONFIG, offsetof(gyroConfig_t, gyroCalibrationDuration) },
...
// PG_IMU_CONFIG
    ...
    { "level_recovery_delay",       VAR_UINT16 | MASTER_VALUE, .config.minmax = { 0, 2000 }, PG_IMU_CONFIG, offsetof(imuConfig_t, level_recovery_delay) },
...
// position as displayed in the GUI.
    ...
    { "osd_heart_rate_pos",     VAR_UINT16  | MASTER_VALUE, .config.minmaxUnsigned = { 0, OSD_POSCFG_MAX }, PG_OSD_ELEMENT_CONFIG, offsetof(osdElementConfig_t, item_pos[OSD_HEART_RATE]) },
    ...
    { "osd_heart_rate_channel",     VAR_UINT8  | MASTER_VALUE, .config.minmaxUnsigned = { 1, MAX_SUPPORTED_RC_CHANNEL_COUNT }, PG_OSD_CONFIG, offsetof(osdConfig_t, heart_rate_channel) },
...
// PG_DISPLAY_PORT_MSP_CONFIG
    ...
    { "redpine_high_res",               VAR_UINT8   | MASTER_VALUE | MODE_LOOKUP, .config.lookup = { TABLE_OFF_ON }, PG_RX_CC2500_SPI_CONFIG, offsetof(rxCc2500SpiConfig_t, redpineHighRes) },
#endif
